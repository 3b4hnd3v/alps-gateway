...
public class FTPFunctions {
    ...
    public void downloadFTPFile(String source, String destination) throws Exception{
    ...
    public boolean checkFiles(String directory, String fileName) throws IOException {
    ...
    // list the files in a specified directory on the FTP
    public ArrayList<String> listFTPFiles(String directory) throws IOException {
    ...
    public static void main(String[] args) {
        try {
            FTPFunctions ftpobj = new FTPFunctions("172.27.5.96", 21, "admin", "");
            ...
            boolean result = ftpobj.checkFiles("/", "MultiWAN.backup");
