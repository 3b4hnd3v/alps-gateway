...
public class SubnetUtils {
    ...
    public String toSlasher(String mask) {
        return ""+pop(toInteger(mask));
    }
    
    public static void main(String[] args) {
    	SubnetUtils su = new SubnetUtils("192.168.0.1/16");
    	SubnetInfo si = su.getInfo();
    	System.out.println("Address "+si.getAddress());
    	System.out.println("Address Count "+si.getAddressCount());
    	System.out.println("Broadcast Address "+si.getBroadcastAddress());
    	System.out.println("Netmask "+si.getNetmask());
    	System.out.println("Network Address "+si.getNetworkAddress());
    	System.out.println("Highest Address "+si.getHighAddress());
    	System.out.println("Lowest Address "+si.getLowAddress());
    	System.out.println("Hotspot Address "+si.getLowAddress()+"0");
    	System.out.println("CiDR Address "+si.getCidrSignature());
    	/*String[] addresses = si.getAllAddresses();
