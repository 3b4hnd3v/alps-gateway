...
<%
String bname = "None", cidr_add = "192.168.0.0/16";
if(request.getParameter("new_location") != null){
	bname = request.getParameter("locname");
	    	...
	    	<form action="create_location.jsp" method="post">
				...
				<div class="callout callout-info">
	      		...
	      		<div class="row">
		      		<div class="col-sm-12">
				      	<label>Name</label>
						<input type="text" class="form-control" name="locname" value="<%= bname %>" /><br />
					</div>
					...
					<div class="col-sm-12">
				      	<label>Address Range (Number of Addresses : <%= noOfAds - 10 %>)</label>
						<input type="text" class="form-control" name="addrange" value="<%= range %>" />
		      		...
		      		<div class="col-sm-4">
						...
						<input type="text" class="form-control" name="ip" value="<%= hs_add %>" /><br />
					</div>
					<div class="col-sm-4">
				      	<label>Network</label>
						<input type="text" class="form-control" name="network" value="<%= netadd %>" /><br />
					</div>
					<div class="form-group col-sm-4">
				      	<label>Subnet Mask</label>
				      	<select class="form-control" name="smask">
				      	<option value="/<%= smask %>">/<%= smask %></option>
				      	<option> </option>
				      	<% 
			               	for (int i = 0; i<=30; i++) {
					...
					<div class="form-group col-sm-12">
						...
						<input type="text" class="form-control" name="rate" value="" placeholder="5M/5M">
					</div>
					<div class="col-sm-12" align="center">
						<div class="callout callout-info">
		                   ...
		                   try{
			                    ...
			                    ResultSet rs1 = cn.createStatement().executeQuery("SELECT * FROM `captive_type`");
			           			while(rs1.next()){
			        	    		...
			        	    		String name =rs1.getString("homepage"); 
			        	%>
