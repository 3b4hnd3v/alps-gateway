    ...
    <div id="collapseOne" class="panel-collapse collapse in">
      <div class="box-body">
      	<form action="create_location.jsp" method="post">
      		...
      		<div class="col-sm-12" align="center"><label>Starting VLAN</label><hr></div>
      		<div class="col-sm-6">
		      	<label>Vlan ID</label>
			...
			<div class="col-sm-6">
      		...
      		<div class="col-sm-12" align="center"><label>Address Pool</label><hr></div>
      		<div class="col-sm-6">
			...
			<div class="form-group col-sm-12">
      		...
      		<div class="col-sm-12" align="center"><label>Security and Authentication</label><hr></div>
