  ...
  <section class="sidebar">
    ...
    <ul class="sidebar-menu">
     ...
     <% if(hm.get("guest_mgt").toString() != null && hm.get("guest_mgt").toString().equals("1")) { %>
      ...
      <li id="reports">
        <a href="reports.jsp">
          <i class="fa fa-area-chart text-red"></i> <span>Local Network Monitor</span>
          <i class="fa fa-angle-left pull-right"></i>
        </a>
      </li>
      <li id="mreports">
        <a href="master_reports.jsp">
          <i class="fa fa-area-chart text-default"></i> <span>WAN Network Monitor</span>
          <i class="fa fa-angle-left pull-right"></i>
        </a>
      </li>
     <%} %>
