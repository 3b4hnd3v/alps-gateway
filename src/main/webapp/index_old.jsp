			...
			<section class="content" >
				    ...
				    <div class="info-box">
				      ...
				      <div class="info-box-content">
				        <span class="info-box-text">User Accounts</span>
				       	<% 
				      	try{ for (Map<String,String> mp : gc.users()) {
				      		String s = mp.get("ret"); %>
				 ...
				 <div class="col-md-3 col-sm-6 col-xs-12">
				   <div class="info-box">
				     ...
				     <div class="info-box-content">
				       ...
				       <% 
				       try{ for (Map<String,String> mp : gc.activeUsers()) {
				    	   ad = mp.get("ret"); %>
				    	   <span class="info-box-number"><%= ad %></span>
				 ...
				 <div class="col-md-3 col-sm-6 col-xs-12">
				   <div class="info-box">
				     ...
				     <div class="info-box-content">
				       ...
				       <% try{ for (Map<String,String> mp : gc.interfaces()) {
							String s = mp.get("ret"); %>
				       		<span class="info-box-number"><%= s %></span>
				       <% } }catch(Exception e){System.out.println("count"+e);}%>
				     </div><!-- /.info-box-content -->
				 ...
				 <div class="col-md-3 col-sm-6 col-xs-12">
				   <div class="info-box">
				     ...
				     <div class="info-box-content">
				       ...
				       <% try{ for (Map<String,String> mp : gc.hosts()) {
							cd = mp.get("ret");%>
				       		<span class="info-box-number"><%= cd %></span>
				       <% }  }catch(Exception e){System.out.println("count"+e);}%>
				     </div><!-- /.info-box-content -->
				   </div><!-- /.info-box -->
				 </div><!-- /.col -->
    				...
    				<div class="col-md-12">
    					<div class="box">
					        <div class="box-header with-border">
					          <h3 class="box-title" id="info">Network Connections</h3>
					          <div class="box-tools pull-right">
					            ...
					            <div class="btn-group">
					              ...
					              <ul class="dropdown-menu" role="menu">
					                <li><a class="btn btn-warning btn-flat" href="monitor.jsp">Monitor Mode <i class="fa fa-binoculars pull-right"></i></a></li>
					                <li><a class="btn btn-success btn-flat" onclick="ConfirmReset()">Refresh <i class="fa fa-refresh pull-right"></i></a></li>
					                <li class="divider"></li>
					        ...
					        <div class="box-body">
					          <div class="row">
					            <div class="col-md-12">
					              ...
					              <div class="chart chart-responsive" id="voltaic_holder" style="height:250px; position:relative;">
					              	<!-- style="background-image: url(dist/img/loading.gif); background-repeat:no-repeat; <img alt="Bandwidth Utilization" class="img-responsive" src="/chart?type=ds&w=700&h=350">-->
					                <!-- Sales Chart Canvas 
					                <canvas id="main" style="height: 400px;"></canvas>-->
					                <small title="Y Axis" class="btn btn-default btn-xs text-danger" style="margin-left:16px;">Connection By Status</small>
					                <div class="chart" id="main" style="height: 200px;"></div>
					                <small title="X Axis" class="btn btn-default btn-xs pull-right text-danger" style="margin-right:25px;">Number Of Devices</small>
				...
				<div class="row">
    				<div class="col-md-12">
    					 <div class="box">
						      <div class="box-header with-border">
						        <h3 class="box-title col-md-9" id="info">Network Connections</h3>
						        <h1 class="box-title col-md-3  pull-right text-info" align="right" id="info">Device Type</h1>
						      </div><!-- /.box-header -->
						      <div class="box-body">
						      	<div class="row">
							         <div class="col-md-12">
				...
				<div class="row">
    				<div class="col-md-12">
    					 <div class="box">
						      <div class="box-header with-border">
						        <h3 class="box-title col-md-9" id="info">Network Connections</h3>
						        <h1 class="box-title col-md-3  pull-right text-info" align="right" id="info">Device OS</h1>
						      </div><!-- /.box-header -->
						      <div class="box-body">
						      	<div class="row">
							         <div class="col-md-12">
							         	<div class="thumbnail">
							              ...
							              <div class="progress-group">
							                <span class="progress-text">iOS Devices</span>
							                <%
							                connect();
							                try {
							              		ResultSet rs1 = cn.createStatement().executeQuery("SELECT COUNT(*) AS `ios` FROM `onlinusers` WHERE device_os='iOS'"); rs1.next();
							            		ios = rs1.getString("ios");
							            		rs1.close();
							            		cn.close();
							            	} catch(Exception e) { ios = "N/A";} %>
							                <span class="progress-number"><b><%= ios %></b></span>
							                <div class="progress sm">
							                  <div class="progress-bar progress-bar-aqua" style="width: <%out.println(ios+"%");%>"></div>
							                </div>
							              </div><!-- /.progress-group -->
							              <div class="progress-group">
							                <span class="progress-text">Android Devices</span>
							                <%
							                connect();
							                try {
							              		ResultSet rs1 = cn.createStatement().executeQuery("SELECT COUNT(*) AS `android` FROM `onlinusers` WHERE device_os='Android'"); rs1.next();
							            		android = rs1.getString("android");
							            		rs1.close();
							            		cn.close();
							            	} catch(Exception e) { android = "N/A";} %>
							                <span class="progress-number"><b><%= android %></b></span>
							                <div class="progress sm">
							                  <div class="progress-bar progress-bar-red" style="width: <%out.println(android+"%");%>"></div>
							                </div>
							              </div><!-- /.progress-group -->
							              <div class="progress-group">
							                <span class="progress-text">Windows Phone</span>
							                <% 
							                 connect();
							                 try {
							               		ResultSet rs1 = cn.createStatement().executeQuery("SELECT COUNT(*) AS `winph` FROM `onlinusers` WHERE device_os = 'Windows Phone'"); rs1.next();
							               		winph = rs1.getString("winph");
							             		rs1.close();
							             		cn.close();
							             	} catch(Exception e) { winph = "N/A";} %>
							                <span class="progress-number"><b><%out.println(winph); %></b></span>
							                <div class="progress sm">
							                  <div class="progress-bar progress-bar-green" style="width: <%out.println(winph+"%");%>"></div>
							                </div>
							              </div><!-- /.progress-group -->
							              <div class="progress-group">
							                <span class="progress-text">Windows PC</span>
							                <% 
							                 connect();
							                 try {
							               		ResultSet rs1 = cn.createStatement().executeQuery("SELECT COUNT(*) AS `windows` FROM `onlinusers` WHERE device_os LIKE 'Windows%' AND device_os!='Windows Phone'"); rs1.next();
							               		windows = rs1.getString("windows");
							             		rs1.close();
							             		cn.close();
							             	} catch(Exception e) { windows = "N/A";} %>
							                <span class="progress-number"><b><%out.println(windows); %></b></span>
							                <div class="progress sm">
							                  <div class="progress-bar progress-bar-green" style="width: <%out.println(windows+"%");%>"></div>
							                </div>
							              </div><!-- /.progress-group -->
							              <div class="progress-group">
							                <span class="progress-text">MAC OS</span>
							                <% 
							                 connect();
							                 try {
							               		ResultSet rs1 = cn.createStatement().executeQuery("SELECT COUNT(*) AS `macos` FROM `onlinusers` WHERE device_os LIKE 'Mac OS%'"); rs1.next();
							               		macos = rs1.getString("macos");
							             		rs1.close();
							             		cn.close();
							             	} catch(Exception e) { macos = "N/A";} %>
							                <span class="progress-number"><b><%out.println(macos); %></b></span>
							                <div class="progress sm">
							                  <div class="progress-bar progress-bar-green" style="width: <%out.println(macos+"%");%>"></div>
							                </div>
							              </div><!-- /.progress-group -->
							              <div class="progress-group">
							                <span class="progress-text">Ubuntu</span>
							                <% 
							                 connect();
							                 try {
							               		ResultSet rs1 = cn.createStatement().executeQuery("SELECT COUNT(*) AS `ubuntu` FROM `onlinusers` WHERE device_os = 'Ubuntu'"); rs1.next();
							               		ubuntu = rs1.getString("ubuntu");
							             		rs1.close();
							             		cn.close();
							             	} catch(Exception e) { ubuntu = "N/A";} %>
							                <span class="progress-number"><b><%out.println(ubuntu); %></b></span>
							                <div class="progress sm">
							                  <div class="progress-bar progress-bar-green" style="width: <%out.println(ubuntu+"%");%>"></div>
							                </div>
							              </div><!-- /.progress-group -->
							              <div class="progress-group">
							                ...
							                <% 
							                 connect();
							                 try {
							               		ResultSet rs1 = cn.createStatement().executeQuery("SELECT COUNT(*) AS `linux` FROM `onlinusers` WHERE device_os = 'Linux'"); rs1.next();
							               		linux = rs1.getString("linux");
							             		rs1.close();
							             		cn.close();
							             	} catch(Exception e) { linux = "N/A";} %>
							                <span class="progress-number"><b><%out.println(linux); %></b></span>
							                <div class="progress sm">
							                  <div class="progress-bar progress-bar-green" style="width: <%out.println(linux+"%");%>"></div>
							                </div>
							              </div><!-- /.progress-group -->
							              <div class="progress-group">
							                ...
							                <% 
							                 connect();
							                 try {
							               		ResultSet rs1 = cn.createStatement().executeQuery("SELECT COUNT(*) AS `others` FROM `onlinusers` WHERE device_os=''"); rs1.next();
							               		others = rs1.getString("others");
							             		rs1.close();
							             		cn.close();
							             	} catch(Exception e) { others = "N/A";} %>
							                <span class="progress-number"><b><%out.println(others); %></b></span>
							                <div class="progress sm">
							                  <div class="progress-bar progress-bar-yellow" style="width: <%out.println(others+"%");%>"></div>
							                </div>
							              </div><!-- /.progress-group -->
						            	</div><!-- /.thumb -->
						            </div><!-- /.col -->
				...
				<div class="row">
	         		<div class="col-md-12">
						<div class="box">
					      <div class="box-header with-border">
					        <h3 class="box-title col-md-9" id="info">ALPS Net Health</h3>
					        <h1 class="box-title col-md-3  pull-right text-danger" align="right" id="info">Network Port Status</h1>
					      </div><!-- /.box-header -->
					      <div class="box-footer">
					        <div class="row">
					          <div class="col-sm-3 col-xs-6">
					            <% try{ 
					            	for (Map<String,String> mp : g.ethernet("LAN")) {
					            		String name = mp.get("name");
					            		String running = mp.get("running");
					            		String disable = mp.get("disabled");
					            		String tc = "red";
					            		String caret = "down";
					            		String speed = mp.get("speed");
					            		String pcon = "danger";
					            		if(Boolean.valueOf(running)){ tc = "green"; caret = "up";}
					            		if(Boolean.valueOf(disable)){ tc = "orange"; caret = "down";}
					            		String addCon = "X Not Found";
					            		for (Map<String,String> mpi : g.interfRouteGw("HostNet")) {
					            ...
					            %>
					            	<div class="description-block border-right">
						              <span class="description-percentage text-<%= tc %>"><i class="fa fa-caret-<%= caret %>"></i></span>
						              <h5 class="description-header"><%= name %></h5>
						              <span class="description-text">
						              	Running : <%= running %>
						              	<br>Disabled : <%= disable %>
						              	<br>Speed : <%= speed %>
						              	<br>Route <% out.print(addCon.split(" ", 0)[1]); %>
						              </span>
						              <small class="text-<%= pcon %>"><br>Connection : <i class="fa fa-circle text-<%= pcon %>"></i></small>
						            </div><!-- /.description-block -->
				                <% } }catch(Exception e){System.out.print(e);}%>
					          </div><!-- /.col -->
					          <div class="col-sm-3 col-xs-6">
					            <% try{ 
					            	for (Map<String,String> mp : g.ethernet("WAN")) {
					            		String name = mp.get("name");
					            		String running = mp.get("running");
					            		String disable = mp.get("disabled");
					            		String tc = "red";
					            		...
					            		if(Boolean.valueOf(running)){ tc = "green"; caret = "up";}
					            		if(Boolean.valueOf(disable)){ tc = "orange"; caret = "down";}
										for (Map<String,String> mpi : g.interfRoute(name)) {
											addCon = mpi.get("gateway-status");
					          ...
					          <div class="col-sm-3 col-xs-6">
					            <% try{ 
					            	for (Map<String,String> mp : g.ethernet("WAN1")) {
					            		String name = mp.get("name");
					            		String running = mp.get("running");
					            		String disable = mp.get("disabled");
					            		String tc = "red";
					          ...
					          <div class="col-sm-3 col-xs-6">
					            <% try{ 
					            	for (Map<String,String> mp : g.ethernet("WAN2")) {
					            		String name = mp.get("name");
					            		String running = mp.get("running");
					            		String disable = mp.get("disabled");
					            		String tc = "red";
				...
				<div class="row">
	         		<div class="col-md-12">
						<div class="box">
					      <div class="box-header with-border">
					        <h3 class="box-title col-md-9" id="info">ALPS Identity</h3>
					        <h1 class="box-title col-md-3  pull-right text-danger" align="right" id="info"><i class="fa fa-eye"></i></h1>
					      </div><!-- /.box-header -->
					      <div class="box-body">
					      	<div class="row">
								<div class="col-md-12">
								    <div class="card hovercard">
								        <div class="card-background">
								            <img class="card-bkimg" alt="" src="dist/img/light-box.jpg">
								            <!-- http://lorempixel.com/850/280/people/9/ -->
								        </div>
								        <div class="useravatar">
								            <img alt="" src="dist/img/wheel.png">
								        </div>
								        <div class="card-info"> <span class="card-title">  <% out.print(dao.getDashValue("client")); %> </span></div>
								    </div>
								    <div class="btn-pref btn-group btn-group-justified btn-group-lg" role="group" aria-label="...">
								        <div class="btn-group" role="group">
								            <button type="button" id="stars" class="btn btn-primary" href="#tab1" data-toggle="tab"><span class="fa fa-server" aria-hidden="true"></span>
								                <div class="hidden-xs">Device</div>
								            </button>
								        </div>
								        <div class="btn-group" role="group">
								            <button type="button" id="favorites" class="btn btn-default" href="#tab2" data-toggle="tab"><span class="fa fa-file" aria-hidden="true"></span>
								                <div class="hidden-xs">License</div>
								            </button>
								        </div>
								        <div class="btn-group" role="group">
								            <button type="button" id="following" class="btn btn-default" href="#tab3" data-toggle="tab"><span class="fa fa-download" aria-hidden="true"></span>
								                <div class="hidden-xs">Back Up</div>
								            </button>
								        </div>
								    </div>
        							...
        							<div class="well">
								      <div class="tab-content">
								        <div class="tab-pane fade in active" id="tab1">
								          <h3>Device Serial : <% out.print(dao.getSetting("serialno")); %></h3>
								          <h3>System Version : <% out.print(dao.getDashValue("version")); %></h3>
								          <h3>Version Info : <% out.print(dao.getDashInfo("version")); %></h3>
								        </div>
								        <div class="tab-pane fade in" id="tab2">
								        	<h3><% out.print(dao.getDashValue("license")); %></h3>
								        	<%
								        	 String li = dao.getDashInfo("license");
								        	 String[] lih = {"Generated For","Expiration Date","Activated On"};
								        	 int i = 0;
								        	 for(String lin : li.split("&")){
								        	%>
								        		<h3><% out.print(lih[i]); %> : <% out.print(lin.split("=")[1]); %></h3>
								        	<% i=i+1;} %>
								        	<h3>License User Support : <% out.print(dao.getSetting("guest_cap")); %></h3>
								        </div>
								        <div class="tab-pane fade in" id="tab3">
								          <h3>Back Up Setting : <% out.print(dao.getDashValue("autobackup")); %></h3>
								          <h3>Last Auto Back Up : <% out.print(dao.getDashValue("lastbackup")); %></h3>
								        </div>
								      </div>
								    </div>
    							</div>
