    ...
    <div class="col-xs-12"><!-- /.box -->
      ...
      <div class="box">
        ...
        <div class="box-footer">
          <div class='row'>
	          <div class='col-md-12'>
	          	<!-- <a href="new_location.jsp"></a> -->
	          	<button type="button" data-toggle="modal" data-target="#myModal" class='btn btn-lg bg-navy col-sm-12'>Add New Location</button>
				  ...
				  <div class="modal-dialog">
				    ...
				    <div class="modal-content">
				      ...
				      <div class="modal-body">
				      	<div class='row'>
	          				<div class='col-md-12'>
	          					<form action="new_location.jsp" method="post">
									...
									<button type="submit" name="new_location" value="create_location" class='btn btn-lg bg-navy col-sm-12'>Add New Location</button>
								</form>
	          				</div>
	          			</div>
				      </div>
