	...
	<section class="content">
	  ...
	  <div class="box" id="myDiv">
        <div class="box-header">
          <h3 class="box-title">Host Scan Result <small>Active devices found in scan</small></h3>
        </div><!-- /.box-header -->
