...
<body class="hold-transition skin-blue layout-boxedxx sidebar-mini">
	<div class="wrapper"><!-- Site wrapper -->
		...
		<%
			...
			try{ 
				for (Map<String,String> mp : gc.BypassedUsers()) {
			 		bd = mp.get("ret");
			 	} 
			...
			<section class="content" >
    				...
    				<div class="col-md-12">
    					<div class="box">
					        <div class="box-header with-border">
					          <h3 class="box-title" id="info">Local Network Connections</h3>
				...
				<div class="box box-solid bg-blue-gradient">
				  <div class="box-header">
				    ...
				    <div class="box-tools pull-right">
				      <button class="btn btn-info btn-sm"><i class="fa fa-dashboard"></i></button>
				    </div>
				  </div>
				  <div class="box-footer no-border">
				    <div class="row">
				    	<% 
				    	try{
				    		for (Map<String,String> mp : g.CPU()) {
				    			String load = mp.get("load");
				    			String cpu = mp.get("cpu");
				    	%>	
								<div class="col-xs-4 text-center" style="border-right: 1px solid #f4f4f4">
									<!-- <input type="text" class="knob" data-readonly="true" value="<%= load %>" data-width="100" data-height="100" data-fgColor="#3c8dbc"> -->
									<input type="text" id="<%= cpu %>" value="<%= load %>"  data-thickness="0.2" data-width="90" data-height="90" data-fgColor="#3c8dbc" data-readonly="true">
									<div class="knob-label" style="text-transform: uppercase;">
										<%= cpu %> - <%= load %> %
										<br>Disk usage:<%= mp.get("disk") %>
									</div>
								</div><!-- ./col -->
								<script>
								  /* jQueryKnob */
				...
				<div class="row">
	         		<div class="col-md-12">
						<div class="box box-solid bg-blue-gradient">
					      <div class="box-header with-border">
					        <h3 class="box-title">Network Connections</h3>
						    <div class="box-tools pull-right">
						      <button class="btn btn-info btn-sm"><i class="fa fa-sitemap"></i></button>
						    </div>
					      </div><!-- /.box-header -->
					            ...
					            <% try{ 
					            	for (Map<String,String> mp : g.ethernet("LAN")) {
					            		...
					            		for (Map<String,String> mpi : g.interfRouteGw("HostNet")) {
											...
											if(mpi.get("active").equalsIgnoreCase("true")){ act = "Active"; };
					            ...
					            %>
					            	<div class="description-block border-right">
						              ...
						              <span class="description-text">
						              	...
						              	<br>Disabled : <%= disable %>
						              	<br>Speed : <%= speed %>
						              	<br>Route <%= act %> / <% out.print(addCon.split(" ", 0)[1]); %>
						              </span>
        							...
        							<div class="well">
								      <div class="tab-content">
								        <div class="tab-pane fade in active" id="tab1">
								          <h6>Device Serial : <% out.print(dao.getSetting("serialno")); %></h6>
								          <h6>System Version : <% out.print(dao.getDashValue("version")); %></h6>
								          <h6>Version Info : <% out.print(dao.getDashInfo("version")); %></h6>
								        </div>
								        <div class="tab-pane fade in" id="tab2">
								        	<h6 class="text-center well"><% out.print(dao.getDashValue("license")); %></h6>
								        	<div class="row">
												<%
												...
												%>
									        			<h6 class="col-sm-6"><% out.print(lih[i]); %> : <% out.print(lin.split("=")[1]); %></h6>
									        	<% 
									        			i=i+1;
									        		} 
									        	%>
								        		<h6 class="col-sm-6">License User Support : <% out.print(dao.getSetting("guest_cap")); %></h6>
								        	</div>
								        </div>
								        <div class="tab-pane fade in" id="tab3">
								          <h6>Back Up Setting : <% out.print(dao.getDashValue("autobackup")); %></h6>
								          <h6>Last Auto Back Up : <% out.print(dao.getDashValue("lastbackup")); %></h6>
								        </div>
								      </div>
								    </div>
    							</div>
